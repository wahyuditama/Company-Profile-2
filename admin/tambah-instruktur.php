                      ...
                      <?php endif ; ?>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="mb-3 row">
                              ...
                              <input type="text" class="form-control" name="nama_instruktur" id="" placeholder="Masukan Nama anda" value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_instruktur'] : '' ?>" required>
                              </div>
                              <div class="col-sm-6 mb-4">
                              <label for="">Bidang Instruktur</label>
                              <input type="text" class="form-control" name="jurusan_instruktur" id="" placeholder="Masukan email anda" value="<?php echo isset($_GET['edit']) ? $rowEdit['jurusan_instruktur'] : '' ?>" required>
                              </div>
                              <!-- <div class="col-sm-6">
